...
export const PRICE_INSTALLATION_CONTADO = process.env.NEXT_PUBLIC_PRICE_INSTALLATION_CONTADO || 9999
export const PRICE_INSTALLATION_FINANCIADO = process.env.NEXT_PUBLIC_PRICE_INSTALLATION_FINANCIADO || 10999

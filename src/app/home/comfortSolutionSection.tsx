...
const ComfortSolutionSection = () => (
  <section className="flex flex-col md:flex-row items-center justify-between py-16 px-10 bg-blue-50/30 text-blue-400">
    <div className="md:w-1/2 text-center md:text-left space-y-4">
      ...
      <button className="bg-blue-200 text-white px-6 py-3 rounded hover:scale-105 transition-transform">Ordena en un Par de Clicks</button>
    </div>
    <div className=" mt-8 md:mt-0 md:w-1/2 flex justify-end hover:scale-105 transition-transform">
